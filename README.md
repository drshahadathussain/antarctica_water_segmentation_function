...
Launch Color Thresholder to begin segmentation
...
Load satellite image in Color Thresholder
Experiment with different color spaces
Adjust thresholds to select water regions
Export segmentation function
Test function on both 2018 and 2020 images
Refine thresholds for robust performance
Calculate water area in both images
Generate change map and statistics
🔍 Key Considerations
...
MATLAB Color Thresholder Documentation
